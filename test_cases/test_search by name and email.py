...
class TestSearchCustomerByEmailAndCompanyName:
    ...
    @pytest.mark.search
    def test_search_customer_using_email_and_cname(self, set_up):
        self.driver = set_up
        ...
        self.search_obj.set_email("kiyjcycyhjc676008@gmail.com")
        self.search_obj.set_company_name("Indian Cricket Team")
        self.search_obj.search_button()
        time.sleep(2)

        # read data from table
        response = self.search_obj.search_by_company_name_and_email("kiyjcycyhjc676008@gmail.com","Indian Cricket Team")
